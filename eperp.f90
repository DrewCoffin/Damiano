	...
	do jj=3,n1-2
	   ...
	   enddo
           ...
           e3(k)=h1(k2)*h3(k2)*e3(k2)/(h1(k)*h3(k))
           k=n2+n2*(jj-1)
           k2=n2-2+n2*(jj-1)
           e2(k)=e2(k2)
           e3(k)=e3(k2)
        ...
        do ii=1,n2
           IF(CENTRED)THEN
              ...
              e3(ii+(1-1)*n2)=-e3(ii+(5-1)*n2)
              e3(ii+(2-1)*n2)=-e3(ii+(4-1)*n2)
              e3(ii+(n1-1)*n2)=-e3(ii+(n1-4-1)*n2)
              e3(ii+(n1-1-1)*n2)=-e3(ii+(n1-3-1)*n2)
           ELSE
              e2(ii+(1-1)*n2)=-e2(ii+(4-1)*n2)
              e2(ii+(2-1)*n2)=-e2(ii+(3-1)*n2)
              e2(ii+(n1-1)*n2)=-e2(ii+(n1-3-1)*n2)
              e2(ii+(n1-1-1)*n2)=-e2(ii+(n1-2-1)*n2)
              e3(ii+(1-1)*n2)=-e3(ii+(4-1)*n2)
              e3(ii+(2-1)*n2)=-e3(ii+(3-1)*n2)
              e3(ii+(n1-1)*n2)=-e3(ii+(n1-3-1)*n2)
              e3(ii+(n1-1-1)*n2)=-e3(ii+(n1-2-1)*n2)
           ENDIF
        enddo
        return
